...
public class ServiceAccountLoggingAspect implements Ordered {
	...
	@Before(value = "org.certificatic.spring.aop.practica24.bank.aop.PointcutDefinition.serviceLayer() && args(account,..)")
	...
	// Define Advice Before que intercepte serviceLayer() y cache los argumentos
	@Before(value = "org.certificatic.spring.aop.practica24.bank.aop.PointcutDefinition.serviceLayer() && args(customerId,..)")
