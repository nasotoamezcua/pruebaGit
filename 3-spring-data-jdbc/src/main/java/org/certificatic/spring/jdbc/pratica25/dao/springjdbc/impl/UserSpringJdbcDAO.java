...
public class UserSpringJdbcDAO extends GenericSpringJdbcDAO<User, Long>
	...
	public void insert(User entity) {
		...
		this.jdbcTemplate.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(
				...
				// Implementar
				// INSERT INTO CUSTOMER_TBL VALUES (null, ?, ?)
		...
		this.jdbcTemplate.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(
					Connection connection) throws SQLException {
				// Implementar
				// INSERT INTO USER_TBL VALUES (null, ?, ?, ?)
				
				PreparedStatement ps = connection.prepareStatement(INSERT_USER, new String[] {
						"USER_ID", "FK_CUSTOMER_ID", "USERNAME","PASSWORD"});
	...
	public void update(User entity) {
		...
		*/
		...
		// Implementado mediante sql y parámetros vararg
		// UPDATE USER_TBL SET USERNAME = ?, PASSWORD = ? WHERE USER_ID = ?
	...
	public User findById(Long id) {
		...
		try {
			// SELECT * FROM CUSTOMER_TBL INNER JOIN USER_TBL ON CUSTOMER_ID=FK_CUSTOMER_ID WHERE USER_ID = ?
	...
	public User delete(User entity) {
		...
		// DELETE FROM ACCOUNT_TBL WHERE FK_CUSTOMER_ID = ?
		...
		this.jdbcTemplate.update(DELETE_USER_WHERE_USER_ID, new Object[] {entity.getId()});
	...
	public List<User> findAll() {
		...
		// SELECT * FROM CUSTOMER_TBL INNER JOIN USER_TBL ON CUSTOMER_ID=FK_CUSTOMER_ID
		userList = this.jdbcTemplate.query(SELECT_ALL_USER_CUSTOMER,
				new ResultSetExtractor<List<User>>() {
			
					// Agregamos el UserRowMapper
