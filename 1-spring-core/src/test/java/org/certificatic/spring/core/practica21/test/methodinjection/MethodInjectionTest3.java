...
import org.certificatic.spring.core.practica21.methodinjection.bean.SingletonBean3;
...
@ContextConfiguration(locations = { MethodInjectionTest3.location })
public class MethodInjectionTest3 {

	public static final String location = "classpath:/spring/practica21/method-injection-context.xml";
	

	@Autowired
	private SingletonBean3 singletonBean1;

	@Autowired
	private SingletonBean3 singletonBean2;
