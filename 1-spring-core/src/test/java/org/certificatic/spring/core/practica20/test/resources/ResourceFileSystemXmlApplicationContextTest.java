...
public class ResourceFileSystemXmlApplicationContextTest {
	...
	public void loadTextFileFileSystemXmlApplicationContextTest() {
		...
		//Cuando es por File se puede omitir el prejio y al incio del path se pone doble diagonal //
		Resource resource = applicationContext.getResource("//home/my-text-file.txt");
