...
import org.certificatic.spring.core.practica21.methodinjection.bean.SingletonBean2;
...
@ContextConfiguration(locations = { MethodInjectionTest2.location })
public class MethodInjectionTest2 {

	public static final String location = "classpath:/spring/practica21/method-injection-context.xml";
	

	@Autowired
	private SingletonBean2 singletonBean1;
